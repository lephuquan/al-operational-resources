...
- Bám **`skills/devops/configure-environment`** cho profile; code log → **`skills/observability/add-logging/README.md`**; trace id → **`skills/observability/implement-request-tracing/README.md`**.
