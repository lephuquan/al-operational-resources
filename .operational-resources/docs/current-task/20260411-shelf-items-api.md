...
- [ ] Code + tests khá»›p Â§3â€“4 (vÃ  Â§7 náº¿u revised)
- [ ] ÄÃ£ cháº¡y `task_contract.required_test_command` vÃ  lÆ°u test evidence
- [ ] Â§4 AC -> test mapping Ä‘Ã£ cáº­p nháº­t tráº¡ng thÃ¡i cuá»‘i
- [ ] Â§12 progress log cÃ³ tÃ³m táº¯t implementation + test evidence
