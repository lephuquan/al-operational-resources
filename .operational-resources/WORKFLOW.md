...
4. `docs/specs/` (feature liên quan) + `docs/api/` nếu đụng API
5. `docs/current-task/` — tạo hoặc cập nhật file task (xem 1.2)
6. `skills/README.md` — chọn skill phù hợp (REST, service, JPA, error, test…)
7. Ticket team — copy **AC, link, số hiệu** vào task file (không paste secret)
