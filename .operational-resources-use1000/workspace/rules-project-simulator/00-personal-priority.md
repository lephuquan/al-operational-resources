...
- **Luôn cập nhật** file task trong **`current-task/YYYYMMDD-ten-task.md`** (một nguồn duy nhất — không tạo bản song song trong `rules/`) **trước khi** bắt đầu task mới hoặc khi đổi hướng task đáng kể.
