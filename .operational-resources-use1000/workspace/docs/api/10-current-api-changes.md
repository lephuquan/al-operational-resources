...
**Task / ticket reference:** SIM-DEMO-1 / SIM-DEMO-2 — mô tả ticket trong `.operational-resources-use1000/workspace/simulator/DEMO-PROJECT-BRIEF.md` (file task flat tùy chọn trong `current-task/` khi chạy simulation đầy đủ); work item đang mở: `.operational-resources-use1000/al-run/current-task/20260417-shelflog-csv-export/TASK.md` (SHELF-EXPORT-1).
