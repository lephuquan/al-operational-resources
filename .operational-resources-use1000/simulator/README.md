...
3. Ticket thực thi (task file) nằm trong **`../current-task/`** — xem dashboard [`../current-task/README.md`](../current-task/README.md). Thứ tự demo: **SIM-DEMO-1** infra trước, rồi **SIM-DEMO-2** feature chính (tên file flat gợi ý trong `DEMO-PROJECT-BRIEF.md`; có thể tạo khi cần). Luồng: **`task-lifecycle/`**.
...
| [`../current-task/README.md`](../current-task/README.md) | **SIM-DEMO-1 / SIM-DEMO-2** — dashboard + tên file gợi ý; chi tiết ticket trong `DEMO-PROJECT-BRIEF.md` |
...
3. Làm **SIM-DEMO-1** trước (infra), rồi **SIM-DEMO-2** (API); cập nhật dashboard `current-task/README.md`.
